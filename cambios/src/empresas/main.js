...
if (canUseFinePointer && cursor && ring) {
...
const interactiveCards = document.querySelectorAll(
  ".dash-kpi, .dash-savings-card, .feature-card, .how-card",
);

if (interactiveCards.length > 0 && canUseFinePointer && !prefersReducedMotion) {
  interactiveCards.forEach((card) => {
    card.addEventListener("mousemove", (e) => {
      ...
      const rotateY = (centerX - e.clientX) / 28;
